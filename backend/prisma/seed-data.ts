...
export const merchantsData: SeedMerchant[] = [
  ...
  },
  {
    ...
    phone: '138-0000-2222',
    items: [
      { id: 'm2_1', name: '精装单间带阳台 (月租)', price: 800.0, originalPrice: 900.0, desc: '家电齐全，拎包入住，近商业中心。', sales: 12, image: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=600&h=300&fit=crop&q=80', category: '租房' },
